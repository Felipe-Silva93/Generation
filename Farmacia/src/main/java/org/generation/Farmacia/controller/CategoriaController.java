...
public class CategoriaController {
	...
	public ResponseEntity<Object> buscarDescricaoCategoria(@RequestParam(defaultValue = "") String descricao) {
		List<Categoria> listaDeCategoria = repository.findAllByDescricaoContainingIgnoreCase(descricao);
	...
	public ResponseEntity<Categoria> post(@RequestBody Categoria nome) {
		return ResponseEntity.status(201).body(repository.save(nome));
	}
